...
static StringInterner staticStringTable = StringInterner::createEmpty();
...
StringInterner ValueKeys::newDerivedStringTable() {
    return StringInterner::createWithParent(staticStringTable);
}
